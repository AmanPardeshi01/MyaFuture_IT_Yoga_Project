...
import logo from "../../../assets/mann.png"
            ...
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        Welcome to MANN MOKSHA YOGA RETREAT, where we offer a peaceful space for all levels of practitioners. Our diverse classes—from gentle Hatha to invigorating Vinyasa—are designed to enhance your well-being and mindfulness. Join us to connect with your body, mind, and spirit, and embark on your journey towards balance and inner peace.
                        </p>
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 MANN MOKSHA YOGA RETREAT</p>
                    </div>
                </div>
            </div>
        </footer>
